package dev.crossvas.vintagecompanion.items.base;

import cpw.mods.fml.relauncher.Side;
import cpw.mods.fml.relauncher.SideOnly;
import dev.crossvas.vintagecompanion.Refs;
...
public class ItemBaseExcavator extends ItemToolBase {

    public Set<Material> mineableBlockMaterials = new HashSet<Material>();

    public ItemBaseExcavator(Materials material) {
        super(material.excavatorId(), material.MATERIAL, material.NAME);
        this.setUnlocalizedName(name + ".excavator");
        MinecraftForge.setToolClass(this, "shovel", material.MATERIAL.getHarvestLevel());
        init();
    }
