...
public class ItemBaseHammer extends ItemToolBase {
    ...
    public ItemBaseHammer(Materials material) {
        super(material.hammerId(), material.MATERIAL, material.NAME);
        this.setUnlocalizedName(name + ".hammer");
        MinecraftForge.setToolClass(this, "pickaxe", material.MATERIAL.getHarvestLevel());
        init();
    }
